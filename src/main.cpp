...
int main() {
    std::string mapFile = "/home/naren/instock/problem-tests/9/map.txt";  // Adjusted path for simplicity
    std::string kingsFile = "/home/naren/instock/problem-tests/9/kings.txt";  // Adjusted path for simplicity
    ...
    std::string solution_path = "solution_9.txt";
