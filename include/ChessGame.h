...
public:
    ...
    void placeKings(const std::vector<King>& allKings);
    void findPaths();
...
private:
    ...
    void updateAdjacentCells(Position pos, int kingIndex, bool block);
    
    
    Position findNextStepAStar(const King& king);
